...
with open(csvpath) as csvfile:
    ...
    for row in budget_data:
        ...
        # Net total amount of Profit for the month
        profit = int(row[1])
        total_profit += profit
        ...
        if previous_month_revenue != 0:
            ...
            # Check if the revenue change is larger than the previously stored greatest increase
        ...
        # Update the previous month revenue with the current month revenue
